                           ...
                           # Counter 1, Load LSB first, MSB second, Mode 3, 16 bit
                           .data:00000010 3e 76                            ld a,0x76
                           .data:00000012 d3 6f                            out (0x6f),a
                           # Counter 2, Load LSB first, MSB second, Mode 3, 16 bit

                           .data:00000014 3e b6                            ld a,0xb6
